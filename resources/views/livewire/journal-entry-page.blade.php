            ...
            <div class="p-6">
                ...
                <form wire:submit="save" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea wire:model="code_snippet" id="code_snippet" rows="4"
                            class="font-mono mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            placeholder="Paste your code snippet here..."></textarea>
                        @error('code_snippet')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
